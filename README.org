...
#+begin_src sh
curl "https://raw.githubusercontent.com/astratagem/dotfield/${GIT_BRANCH}/machines/${NEW_HOSTNAME}/disk-config.nix" -o /tmp/disk-config.nix
...
:END:
#+begin_src sh
git clone https://github.com/astratagem/dotfield.git -b "${GIT_BRANCH}" /mnt/etc/nixos
