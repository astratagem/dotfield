...
1. **Generate Title**: Create a concise, descriptive title (max 40 characters)
1. **Set Title**: Execute the `scripts/set_title.sh` script with the generated title
1. **No Confirmation Needed**: This happens automatically in the background
